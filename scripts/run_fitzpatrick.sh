#!/usr/bin/env bash
# Full BRIDGE chain for Fitzpatrick: ERM* -> s26f (attr + noattr)
#
# Usage:
...
echo "============================================================"
echo "  Fitzpatrick BRIDGE chain (ERM* -> s26f)"
...
python -u train_erm.py \
    ...
    --num-workers 8 \
    --seed "$SEED" \
    --out-dir results/s19_subpop_rn50_star

echo "=== STEP 1 COMPLETE: $(date) ==="

ERM_CKPT=$(ls -t results/s19_subpop_rn50_star/${DATASET}/erm/*_s${SEED}/model_best_wga.pt 2>/dev/null | head -1)
