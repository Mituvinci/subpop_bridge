#!/usr/bin/env bash
# Three-stage BRIDGE chain for MetaShift (seed 0)
...
#
# Usage:
#   sbatch --time=03:00:00 --partition=gpu_2day \
#     --mem=48G --gres=gpu:1 --cpus-per-task=4 \
#     --job-name=chain3_metashift_s0 \
#     --output=logs/chain3_metashift_s0_%j.out \
#     --error=logs/chain3_metashift_s0_%j.err \
#     scripts/chain_3stage_metashift.sh
