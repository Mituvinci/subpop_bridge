#!/usr/bin/env bash
# Three-stage BRIDGE chain for Waterbirds (seed 0)
...
#     --job-name=chain3_waterbirds_s0 \
#     --output=logs/chain3_waterbirds_s0_%j.out \
#     --error=logs/chain3_waterbirds_s0_%j.err \
#     scripts/chain_3stage_waterbirds.sh
